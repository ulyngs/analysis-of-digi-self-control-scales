...
```{r}
numeric_data <- read_csv(here("data", "2020-03_victoria_study", "scales_numeric.csv"))
textual_data <- read_csv(here("data", "2020-03_victoria_study", "scales_text.csv"))
...
```{r}
survey <- read_csv(here("data", "2020-03_victoria_study", "scales_text.csv"), skip = 1) %>% 
  janitor::clean_names() %>% 
  select(-x1) %>% 
